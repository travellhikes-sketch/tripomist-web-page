  ...
  return (
    <div className="flex flex-col min-h-screen bg-surface-container-lowest">
      ...
      <section className="relative w-full h-72 md:h-96 flex items-end pb-10 px-6 md:px-12 overflow-hidden">
        <img
          src="https://images.unsplash.com/photo-1595815771614-ade9d652a65d?w=1200&q=80"
          alt="Kashmir Valley"
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto">
          ...
          <div className="hidden md:flex relative w-full items-end justify-between">
            <div className="w-1/3">
              ...
              <h1 className="text-white text-4xl md:text-5xl font-bold leading-tight">Kashmir</h1>
              <p className="text-white/80 mt-2 text-base">Heaven on Earth — experience the tranquil lakes and snow-capped peaks.</p>
            </div>
          ...
          <div className="md:hidden flex flex-col gap-6">
            <div>
              <p className="text-emerald-400 text-sm font-semibold tracking-widest uppercase mb-1">Explore India</p>
              <h1 className="text-white text-4xl font-bold leading-tight">Kashmir</h1>
              <p className="text-white/80 mt-2 text-base">Heaven on Earth — experience the tranquil lakes and snow-capped peaks.</p>
            </div>
