    ...
    <div className="flex flex-col min-h-screen bg-surface-container-lowest">
      ...
      <section className="relative w-full h-72 md:h-96 flex items-end pb-10 px-6 overflow-hidden">
        ...
        <div className="relative z-10">
          <p className="text-orange-300 text-sm font-semibold tracking-widest uppercase mb-1">Explore India</p>
          <h1 className="text-white text-4xl md:text-5xl font-bold leading-tight">Rajasthan</h1>
          <p className="text-white/80 mt-2 text-base max-w-md">Land of Maharajas — majestic forts and vibrant culture.</p>
        </div>
      </section>
