      ...
      <section className="w-full max-w-6xl mx-auto px-4 pt-12 pb-6">
        <div className="flex-1">
          <h2 className="font-headline-md text-headline-md text-on-surface font-bold mb-4">
            About Family Destinations
          </h2>
          <ReadMoreText text="Create unforgettable moments with your loved ones. Our Family Destinations are carefully curated to ensure comfort, safety, and fun activities for all age groups." />
        </div>
      </section>
