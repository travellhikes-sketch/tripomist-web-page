...
const DestinationPackages = () => {
  ...
  useEffect(() => {
    const fetchPackages = async () => {
      ...
      // Basic formatting of the slug to match common state/destination patterns (e.g. spiti-valley -> Spiti Valley)
  ...
  const pageTitle = destinationSlug?.split('-').map(word => word.charAt(0).toUpperCase() + word.slice(1)).join(' ') || 'Packages';
      ...
      <main className="w-full flex-grow pt-24 pb-12 px-4 md:px-12 lg:px-20 bg-surface-container-lowest">
        <div className="max-w-7xl mx-auto">
          <div className="mb-8">
            ...
            <p className="text-gray-500 mt-2">Discover our best packages for {pageTitle}.</p>
          </div>
