    ...
    <div className="flex flex-col min-h-screen bg-surface-container-lowest">
      ...
      <section className="w-full max-w-6xl mx-auto px-4 pt-12 pb-6">
        <h2 className="font-headline-md text-headline-md text-on-surface font-bold mb-4">
          About Meghalaya Tour Packages
        </h2>
        <ReadMoreText text="What if we say to you that there's a place wherein the clouds came down to greet the mountains, where rivers whisper the old secrets, and where time slows down just to make you able to take it all in? Meghalaya is that magical place, waiting for you to explore its untouched beauty." />
